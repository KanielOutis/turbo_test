...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { body: @concert.body, date: @concert.date, title: @concert.title } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { body: @concert.body, date: @concert.date, title: @concert.title } }
